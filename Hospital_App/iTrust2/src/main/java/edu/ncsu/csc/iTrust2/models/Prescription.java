...
public class Prescription extends DomainObject {
    ...
    /** ID of this Prescription */
    @Id
    @GeneratedValue ( strategy = GenerationType.AUTO )
    private Long      id;

    /** Drug prescribed with this Prescription */
    @NotNull
    @ManyToOne
    private Drug      drug;

    /** Dosage of this prescription */
    @Min ( 1 )
    private int       dosage;

    /** Date the Prescription is to start at */
    @NotNull
    @Basic
    ...
    /** Date the Prescription is to end at */
    @NotNull
    @Basic
    // Allows the field to show up nicely in the database
    @Convert ( converter = LocalDateConverter.class )
